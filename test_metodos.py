...
def resp_correcta_metodo1(dato):
    ...
    if isinstance(dato, int) and dato>=0: #solo si cumple las condiciones de ser numero entero positivo procede
...
class TestMetodos(unittest.TestCase):
    def test_add(self):
        ...
        arreglo_prueba = [prueba[random.randint(0, 6)],prueba[random.randint(0, 6)]]     
