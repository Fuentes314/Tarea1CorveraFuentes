from math import factorial  # importacion de libreria para factorial


def numero_int(entrada):  # función que verifica que el numero sea entero
    return isinstance(entrada, int)  # si es entero regresa True
...
3141 #codigo de error para elemento del arreglo que
